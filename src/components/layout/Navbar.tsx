      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center gap-1.5">
            ...
            {/* Pig Farming Game Button */}
            <Link
              to="/game"
              className={`px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wide transition-all shadow-sm whitespace-nowrap flex items-center gap-1 ${
                isActive("/game")
            ...
            >
              ...
              <span className="hidden xl:inline">PIG FARMING GAME</span>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-100 bg-white">
            ...
            {/* Pig Farming Game - Mobile */}
            <Link
              to="/game"
              onClick={() => setMobileMenuOpen(false)}
              className={`flex items-center gap-2 mx-4 mb-2 px-4 py-3 font-medium rounded-xl transition-colors ${
                isActive("/game")
                  ? "bg-purple-700 text-white"
                  : "bg-purple-600 text-white hover:bg-purple-700"
              }`}
